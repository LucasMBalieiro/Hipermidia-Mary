...
public class DrawMesh : MonoBehaviour
{
    ...
    private List<GestureTemplate> gestureTemplates = new List<GestureTemplate>();
    ...
    {
        // --- Template for a horizontal line ---
        List<Vector2> linePoints = new List<Vector2>
        {
            new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0)
        };
        gestureTemplates.Add(PennyPincher.CreateTemplate("Horizontal Line", linePoints));
        
        // --- Template for a 'V' shape ---
        List<Vector2> vPoints = new List<Vector2>
        {
            new Vector2(0, 1), new Vector2(1, 0), new Vector2(2, 1)
        };
        gestureTemplates.Add(PennyPincher.CreateTemplate("V Shape", vPoints));
        ...
        gestureTemplates.Add(PennyPincher.CreateTemplate("^ Shape", aPoints));
    }
}
